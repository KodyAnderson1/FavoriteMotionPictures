...
//        launch();
    	...
    	String jdbcURL = "jdbc:derby:trainsdb;create=true";
...
//    	try {
//			databaseConnection.init("database.properties");
//			conn = databaseConnection.getConnection();
//	    	String sqlTable = "CREATE TABLE test(id int, name varchar(128), price float)";
